...
class JDOutputSchema(BaseModel):
    ...
    domain_skills: list[str] = Field(
        description="The domain skills required for the job position."
    )
    ...
    educational_qualification: str = Field(
        description="The educational qualification required for the job position."
    )
    mandatory_certifications: list[str] = Field(
        description="The mandatory certifications required for the job position."
    )
    nice_to_have_certifications: list[str] = Field(
        description="The nice-to-have certifications for the job position."
    )
